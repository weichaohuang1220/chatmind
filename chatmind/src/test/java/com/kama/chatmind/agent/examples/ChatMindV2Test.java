package com.kama.chatmind.agent.examples;

import com.kama.chatmind.agent.tools.test.CityTool;
import com.kama.chatmind.agent.tools.test.DateTool;
import com.kama.chatmind.agent.tools.test.WeatherTool;
...
public class ChatMindV2Test {
    ...
    public void testToolCalling() {
        ...
        // 创建 V2 实例
        ChatMindV2 agent = new ChatMindV2(
                "test-agent-v2",
                "测试 Agent V2",
