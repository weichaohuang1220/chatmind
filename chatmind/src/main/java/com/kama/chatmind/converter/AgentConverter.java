...
public class AgentConverter {
    ...
    public Agent toEntity(AgentDTO agentDTO) throws JsonProcessingException {
        ...
        return Agent.builder()
                ...
                .allowedSkills(agentDTO.getAllowedSkills() != null
                        ? objectMapper.writeValueAsString(agentDTO.getAllowedSkills())
                        : "[]")
    ...
    public AgentDTO toDTO(Agent agent) throws JsonProcessingException {
        ...
        return AgentDTO.builder()
                ...
                .allowedSkills(agent.getAllowedSkills() != null
    ...
    public AgentVO toVO(AgentDTO dto) {
        return AgentVO.builder()
                ...
                .allowedSkills(dto.getAllowedSkills())
                .build();
    }
    ...
    public AgentDTO toDTO(CreateAgentRequest request) {
        ...
        return AgentDTO.builder()
                ...
                .allowedSkills(request.getAllowedSkills() != null ? request.getAllowedSkills() : Collections.emptyList())
                .build();
    }
